        ...
        {activeTab === 'dashboard' && (
          <div className="flex flex-col items-center justify-center py-4 md:py-12 text-center px-4 animate-in fade-in duration-200 w-full max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
              <button 
                onClick={() => setActiveTab('search')}
                className="p-5 bg-zinc-900/60 hover:bg-zinc-800/40 border border-zinc-850 hover:border-amber-500/30 rounded-3xl text-left transition-all cursor-pointer shadow-lg group flex items-start gap-4 active-touch"
              >
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 shrink-0 select-none">
                          ...
                          <button
                            ...
                            className="bg-zinc-900 hover:bg-zinc-850 border border-zinc-800 hover:border-zinc-700 text-zinc-400 hover:text-rose-450 px-3.5 py-1.8 rounded-xl text-[10px] uppercase font-mono tracking-wider transition-all active:scale-95 cursor-pointer active-touch"
                          >
                            Dismiss
                          </button>
                        </div>
