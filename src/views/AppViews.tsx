                      ...
                      >
                        <div className="text-left flex-1 min-w-0">
                          ...
                          <p className="text-[9.5px] text-zinc-550 mt-2 font-mono uppercase tracking-wider">
                            Suggested by <span className="text-zinc-450 font-bold font-sans normal-case">{sug.suggestedBy || 'Choir Member'}</span> &bull; {new Date(sug.timestamp).toLocaleDateString()}
                          </p>
                        </div>
